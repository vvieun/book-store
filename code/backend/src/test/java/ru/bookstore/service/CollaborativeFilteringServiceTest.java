...
class CollaborativeFilteringServiceTest {
    ...
    @InjectMocks
    private CollaborativeFilteringServiceImpl service;
    ...
    void testGetRecommendations_UserWithNoReviews_ReturnsEmpty() {
        ...
        List<Recommendation> result = service.getUserBasedRecommendations(1L, 10);
    ...
    void testGetRecommendations_WithSimilarUser_ReturnsRecommendations() {
        ...
        when(bookRepository.findById("isbn-2")).thenReturn(Optional.of(book2));
    ...
    void testGetRecommendations_NonExistentUser_ReturnsEmpty() {
        ...
        List<Recommendation> result = service.getUserBasedRecommendations(9999L, 10);
    ...
    void testGetRecommendations_LimitZero_ReturnsEmpty() {
        ...
        List<Recommendation> result = service.getUserBasedRecommendations(1L, 0);
